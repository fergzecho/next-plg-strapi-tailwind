...
console.log(FeaturedImage.data.attributes.url)
  ...
  return (
    <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><Link href={'/blog/'+Slug}>{Title}</Link></h2>
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-4">
                        <Image className="w-7 h-7 rounded-full" src={FeaturedImage.data.attributes.url} width="50" height="50" alt="Jese Leos avatar" />
                        <span className="font-medium dark:text-white">
                            Sample
                        </span>
                    </div>
                    <Link href={"/blog/"+ Slug} className="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                        Read more
