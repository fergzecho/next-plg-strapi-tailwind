        ...
        <section className="bg-dark dark:bg-gray-900">
            <div className="grid max-w-screen-xl px-4 py-12 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                  ...
                  { isLogin ?  <button onClick={logout} className="block mt-6">Logout</button> :  <Login />}
                ...
                <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                    <Image src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/phone-mockup.png" height="300" width="400" alt="mockup" />
                </div>                
            </div>
        </section>
      </main>
